...
namespace avocado {
   ...
   const float cameraSpeedMult = 4.5f;
   ...
   struct vertex {
       ...
       glm::vec3 normal;
       glm::vec2 texcoord;
       //vertex(const positionAndNormal& posAndNorm, const glm::vec2& tcoord) 
       //    : position(posAndNorm.position)
       //    , normal(posAndNorm.normal)
       //    , texcoord(tcoord)
       //{
   ...
   struct renderapp final : application {
      ...
      glm::mat4 wallLeft = identity;
      glm::mat4 wallRight = identity;
      glm::mat4 wallFront = identity;
      glm::mat4 wallBack = identity;
      glm::mat4 ceiling = identity;
